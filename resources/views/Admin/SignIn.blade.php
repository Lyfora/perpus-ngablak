...
<body class="h-full">
    <div class="min-h-screen flex">
        <div class="w-full md:w-2/5 flex flex-col justify-center items-center px-12">
            <img class="w-1/2" src={{ url('image/logo-perpus.png') }} alt="">
            <h1 class="text-4xl font-bold text-blue-700">Selamat Datang</h1>
            <p class="text-gray-500">Silahkan Login untuk memulai sesi anda</p>
            <form class="mt-8 space-y-6 w-full" action={{ route('signin') }} method="POST">
                @csrf
                @method('POST')
